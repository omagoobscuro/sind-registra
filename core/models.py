...
class Juridico(models.Model):
    ...
    cpf_reclamante = models.CharField(max_length=100, null=True, blank=True, unique=True)
    reclamado = models.ForeignKey(Empresa, on_delete=models.CASCADE)
    cnpj_reclamado = models.CharField(max_length=100, null=True, blank=True, unique=True)
